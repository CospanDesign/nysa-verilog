...
"""
wb_host_interface_tester Driver
...
class wb_host_interface_testerDriver(driver.Driver):

    """ wb_host_interface_tester

        Communication with a DutDriver wb_host_interface_tester Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_host_interface_testerDriver, self).__init__(nysa, urn, debug)
