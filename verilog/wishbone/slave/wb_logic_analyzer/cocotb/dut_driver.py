...
class wb_logic_analyzerDriver(driver.Driver):

    """ wb_logic_analyzer

        Communication with a DutDriver wb_logic_analyzer Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_logic_analyzerDriver, self).__init__(nysa, urn, debug)
