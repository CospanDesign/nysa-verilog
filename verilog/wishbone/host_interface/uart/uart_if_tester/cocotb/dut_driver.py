...
class uart_if_testerDriver(driver.Driver):

    """ uart_if_tester

        Communication with a DutDriver uart_if_tester Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(uart_if_testerDriver, self).__init__(nysa, urn, debug)
