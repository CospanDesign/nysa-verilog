...
class wb_master_testDriver(driver.Driver):

    """ wb_master_test

        Communication with a DutDriver wb_master_test Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_master_testDriver, self).__init__(nysa, urn, debug)
