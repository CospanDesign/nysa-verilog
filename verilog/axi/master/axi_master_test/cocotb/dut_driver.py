...
class axi_master_testDriver(driver.Driver):

    """ axi_master_test

        Communication with a DutDriver axi_master_test Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(axi_master_testDriver, self).__init__(nysa, urn, debug)
